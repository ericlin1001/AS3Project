package  
{
	...
	public class Triangle 
	{
		...
		public function draw(g:Graphics, tcolor:uint =0xffffff,alpha:Number=1):void {
			...
			//	trace("factor", getColorFactor());
				red =Math.min(0xff,red*getColorFactor());
				green = Math.min(0xff, green * getColorFactor());
				blue =Math.min(0xff,blue*getColorFactor());
				//draw;
				//g.lineStyle(0,red<<16|green<<8|blue);
			//	trace(red << 16 | green << 8 | blue);
				g.beginFill (red<<16|green<<8|blue,alpha);
